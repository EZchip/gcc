...
(define_insn "*movsi_insn"
  [(set (match_operand:SI 0 "move_dest_operand" "=Rcq,Rcq#q,w, w,w,  w,  w,  w,  w,???w, ?w,  w,Rcq#q, w,Rcq,  S,Us<,RcqRck,!*x,r,m,???m,VUsc")
	(match_operand:SI 1 "move_src_operand"  " cL,cP,Rcq#q,cL,I,Crr,Clo,Chi,Cbi,?Rac,Cpc,Clb,?Cal,?Cal,T,Rcq,RcqRck,Us>,Usd,m,c,?Rac,C32"))]
   ...
   * return arc_short_long (insn, \"pop%? %0%&\",  \"ld%U1 %0,%1%&\");
   ...
   st%U0%V0 %1,%0       ;21
   st%U0%V0 %S1,%0      ;22"
  [(set_attr "type" "move,move,move,move,move,shift,shift,shift,shift,move,binary,binary,move,move,load,store,store,load,load,load,store,store,store")
   (set_attr "iscompact" "maybe,maybe,maybe,false,false,false,false,false,false,false,false,false,maybe_limm,false,true,true,true,true,true,false,false,false,false")
   ; Use default length for iscompact to mark length varying.  But set length
   ; of Crr/Cbi to 4.
   (set_attr "length" "*,*,*,4,4,4,4,4,4,4,8,8,*,8,*,*,*,*,*,*,*,*,8")
   (set_attr "cond" "canuse,canuse_limm,canuse,canuse,canuse_limm,canuse_limm,canuse_limm,canuse_limm,canuse_limm,canuse,nocond,nocond,canuse,canuse,nocond,nocond,nocond,nocond,nocond,nocond,nocond,nocond,nocond")])
...
(define_insn "*tst"
  [(set
     ...
     (match_operator 3 "zn_compare_operator"
	  ...
	  (match_operand:SI 2 "nonmemory_operand"  "Rcq,C0p,cI,C1p,Ccp,Chs,Cal"))
	(const_int 0)]))]
  "reload_completed
  ...
  [(set_attr "iscompact" "maybe,maybe,false,false,false,false,false")
   (set_attr "type" "compare,compare,compare,compare,compare,shift,compare")
...
(define_insn "*noncommutative_binary_comparison_result_used"
  [(set (match_operand 3 "cc_register" "")
   ...
   (set (match_operand:SI 0 "register_operand" "=w,w,w")
	(match_dup 4 ))]
  "TARGET_SHIFTER || GET_CODE (operands[4]) == MINUS"
  "%O4.f %0,%1,%2"
  [(set_attr "type" "compare,compare,compare")
   (set_attr "cond" "set_zn,set_zn,set_zn")
   (set_attr "length" "4,4,8")])
...
(define_insn "*zero_extendqihi2_i"
  ...
  [(set_attr "type" "unary,unary,unary,unary,load")
   ...
   (set_attr "cond" "nocond,nocond,canuse,nocond,nocond")])
...
(define_insn "*zero_extendqisi2_ac"
  ...
  [(set_attr "type" "unary,unary,unary,unary,load,load,load")
   ...
   (set_attr "cond" "nocond,nocond,canuse,nocond,nocond,nocond,nocond")])
...
(define_insn "*call_i"
  [(call (mem:SI (match_operand:SI 0 "call_address_operand" "Rcq,q,c,Cbr,L,I,Cal"))
	 (match_operand 1 "" ""))
   (clobber (reg:SI 31))]
  ""
  "@
...
(define_insn "*call_value_i"
  [(set (match_operand 0 "dest_reg_operand"  "=Rcq,q,w,  w,w,w,  w")
	(call (mem:SI (match_operand:SI 1
		       "call_address_operand" "Rcq,q,c,Cbr,L,I,Cal"))
	      (match_operand 2 "" "")))
   (clobber (reg:SI 31))]
  ""
  "@
  ...
  emit_insn
    (gen_rtx_COND_EXEC
      (VOIDmode,
       ...
       gen_rtx_SET (VOIDmode, operands[0], plus_constant (operands[0], 1))));
  DONE;
})
